...
class  Libro{
	...
	function __construct($id=0,$imagen='',$titulo='',$autor='',$descripcion='',$precio=0,$cantidadalquiler=0,$cantidadvender=0,$genero='')
	{
		$this->id = $id;
        $this->imagen=$imagen;
		$this->titulo=$titulo;
	...
	public function insert() {
		...
		$insercion = "INSERT INTO libros (id,imagen,titulo,autor,descripcion,precio,cantidadalquiler,cantidadvender,genero) VALUES ('$this->id','$this->imagen','$this->titulo','$this->autor','$this->descripcion','$this->precio','$this->cantidadalquiler','$this->cantidadvender','$this->genero')";
        //echo $insercion;
	...
	public static function getLibro() {
		...
		while ($registro = $consulta->fetchObject()) {
			$libros[] = new Libro($registro->id,$registro->imagen, $registro->titulo,$registro->autor,$registro->descripcion,$registro->precio,$registro->cantidadalquiler,$registro->cantidadvender,$registro->genero);
		}
