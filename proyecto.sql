...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-06-2020 a las 16:15:31
...
('Jesús Daniel Alors Barrera', 'Ny3', '12385512i', 'jesus@gmail.com', 623698744),
...
(2, 'alicia2.jpg', 'Alicia en el País de las Maravillas', 'Lewis Carroll', 'Un día aburrido como tantos otros, Alicia se duerme y de este modo entra en el País de las Maravillas de la mano del Conejo Blanco.', 29.26, 10, 12, 'Novela Contemporanea', '3º Edición', 'Habilitado'),
...
(4, 'cuentoperfecto.jpg', 'Un Cuento Perfecto', 'Elisabet Benavent', 'Érase una vez una mujer que lo tenía todo y un chico que no tenía nada.', 17, 10, 6, 'Novela Romántica', '4º Edición', 'Habilitado'),
...
(13, 'ElCorazon.jpg', 'El Corazón Con Que Vivo', 'Jose María Pérez Peridis', 'Ganador Premio Primavera Novela 2020. Novela apasionante sobre el poder de los afectos y la necesidad de  reconciliación.', 19.98, 9, 9, 'Novela Contemporanea', '1º Edición', 'Habilitado'),
...
(18, 'Recordar.jpg', 'Recordar Contraseña', 'Defreds Jose. A. Gomez Iglesias', 'Nos pasamos la vida recordando. ¿En qué momento nos conocimos? ¿Dónde habré dejado las llaves?', 12.75, 10, 8, 'Poesía', '1º Edición', 'Habilitado'),
...
(12, '@javier', '15409923s', 'javi_85perez@hotmail.com', 'Calle Pedroso,22', 41710, 626587153, 'Ny3'),
...
--
ALTER TABLE `usuarios`
  MODIFY `id` int(60) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
