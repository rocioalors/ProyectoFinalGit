...
<div class="container">
<h1 class="titulo">UPSS PARECE QUE ESOS DATOS YA ESTAN REGISTRADOS</h1>
<h5 class="texto">¿Que desea hacer?</h5><br>
<a href="../Controller/verCatalogo.php"><button class="btn btn-info">Volver al catálogo</button></a>
<a href="../Controller/nuevoLibro.php"><button class="btn btn-info">Volver al formulario</button></a>

<img  id="advertencia" src="../View/img/advertencia.png">
</div>
