...
<div class="container"> 
 ...
 <input type="hidden" name="id" value="<?=$id?>">
  <h6 class="texto" for="usr">Nombre: <?=$nombre?></h6><br>
  <input type="hidden" class="form-control" id="nombre" name="nombre" value="<?=$nombre?>">

  <h6 class="texto" for="usr">Dni: <?=$dni?></h6><br>
  <input type="hidden" class="form-control" id="dni" name="dni" value="<?=$dni?>">

  <h6 class="texto" for="usr">Email: <?=$correo?></h6><br>
